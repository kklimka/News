...
function NewsCard() {
    ...
    <Card sx={{ maxWidth: 350, marginBottom: 10 }}>
        ...
        <CardContent>
            <Typography sx={{ marginBottom: 1, marginTop: -1, fontSize: 14 }} color="text.secondary" className='dateBox'>
                <CalendarMonth className='dateIcon' />June 29th, 2021
            </Typography>
        ...
        <CardActions>
            <Link to="/article">
            <Button size="small" sx={{ color: '#363636', fontWeight: 700 }} className='moreInformationButton'>
